...
/*            pq.add("6", 6);
        ...
        void removeMinRepeatedly_returnsItemsInCorrectOrder() {
            ExtrinsicMinPQ<String> pq = setUpMinPQ();
            //pq.add("test", 0);
            //boolean temp = pq.contains("null");
/*            pq.changePriority("6", 3);
            pq.changePriority("6", 2);
            pq.changePriority("6", 0);
            pq.changePriority("6", 4);*/
/*            pq.add("7", 7);
            pq.add("8", 8);
            pq.add("9", 9);*/
/*            String a = pq.removeMin();
            String b = pq.removeMin();
            String c = pq.removeMin();
            String d = pq.removeMin();*/
            //pq.add("10", 10);
            //pq.changePriority("6", 0);
            //pq.add("-8", -8);
            pq.changePriority("6", -2);
            String check = pq.removeMin();
            boolean temp = pq.contains("null");
